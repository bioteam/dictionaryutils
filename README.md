...
* Travis Build Status BRANCH **esther** [![Build Status](https://travis-ci.com/bioteam/dictionaryutils.svg?branch=esther)](https://travis-ci.com/github/bioteam/dictionaryutils/branches)
* Dictionary Schema BRANCH **esther** [schema.json](https://bms-gen3-dev.s3.amazonaws.com/datadictionary/esther/schema.json)
* Dictionary Visualization BRANCH **esther** [dictionary-visualizer](https://bms-gen3-dev.s3.amazonaws.com/datadictionary/master/viz/index.html#https://bms-gen3-dev.s3.amazonaws.com/datadictionary/esther/schema.json)
