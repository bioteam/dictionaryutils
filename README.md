...
* Travis Build Status BRANCH **stdh** [![Build Status](https://travis-ci.com/bioteam/dictionaryutils.svg?branch=stdh)](https://travis-ci.com/github/bioteam/dictionaryutils/branches)
* Dictionary Schema BRANCH **stdh** [schema.json](https://bms-gen3-dev.s3.amazonaws.com/datadictionary/stdh/schema.json)
* Dictionary Visualization BRANCH **stdh** [dictionary-visualizer](https://bms-gen3-dev.s3.amazonaws.com/datadictionary/master/viz/index.html#https://bms-gen3-dev.s3.amazonaws.com/datadictionary/stdh/schema.json)
